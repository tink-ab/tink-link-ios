...
final class ProviderLoadingErrorView: UIView {
    ...
    private func setup() {
        ...
        retryButton.text = NSLocalizedString("ProviderPicker.Error.RetryButton", tableName: "TinkLink", value: "Try again", comment: "Title for button to try loading providers again.")
    ...
    func configure(with error: Error?) {
        textLabel.text = NSLocalizedString("ProviderPicker.Error.Title", tableName: "TinkLink", value: "We’re sorry, but we couldn't load any banks at the moment", comment: "Title for when providers could not be loaded.")
