...
final class AddCredentialStatusViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        cancelButton.setTitle(NSLocalizedString("AddCredentials.Status.Cancel", tableName: "TinkLink", value: "Cancel", comment: "Title for button to cancel an ongoing task for adding credentials."), for: .normal)
