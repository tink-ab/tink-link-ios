...
class AddCredentialClientNotVerifiedView: UIView {
    ...
    private func setup() {
        ...
        unVerifiedLabel.text = NSLocalizedString("AddCredentials.Warning.UnverifiedClient", tableName: "TinkLinkUI", bundle: .tinkLinkUI, value: "Unverified - This solution is only made for development purposes. Do not enter you bank credentials unless you trust the developer.", comment: "Text for the warning shown when the user is unverified.")
