...
final class AddCredentialFooterView: UIView {
    ...
    private lazy var descriptionTextView: UITextView = {
        ...
        let text = NSLocalizedString("AddCredentials.Consent.ServiceAgreement", tableName: "TinkLink", value: "By using the service, you agree to Tink’s Terms and Conditions and Privacy Policy", comment: "Text explaining that when using the service, the user agrees to Tink's Terms and Conditions and Privacy Policy.")
        ...
        let privacyPolicyText = NSLocalizedString("AddCredentials.Consent.PrivacyPolicy", tableName: "TinkLink", value: "Privacy Policy", comment: "Title of the Privacy Policy link. This has to match the mention of the Privacy Policy in the AddCredentials.Consent.ServiceAgreement string.")
        ...
        let termsAndConditionsText = NSLocalizedString("AddCredentials.Consent.TermsAndConditions", tableName: "TinkLink", value: "Terms and Conditions", comment: "Title of the Privacy Policy link. This has to match the mention of the Terms and Conditions in the AddCredentials.Consent.ServiceAgreement string.")
