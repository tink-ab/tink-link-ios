...
enum Strings {
    ...
    enum Credentials {
        ...
        enum Validation {
            ...
            static let maxLengthLimit = NSLocalizedString("Credentials.Validation.MaxLengthLimit", tableName: tableName, bundle: bundle, value: "%@ cannot be longer than %d characters.", comment: "Text for field validation error shown when text entered exceeds character limit.")

            /// Text for field validation error shown when text entered is shorter than required.
            static let minLengthLimit = NSLocalizedString("Credentials.Validation.MinLengthLimit", tableName: tableName, bundle: bundle, value: "%@ must be at least %d characters.", comment: "Text for field validation error shown when text entered is shorter than required.")

            ///Text for field validation error shown when no text is entered for a required field.
            static let requiredFieldEmptyValue = NSLocalizedString("Credentials.Validation.RequiredFieldEmptyValue", tableName: tableName, bundle: bundle, value: "You must enter %@.", comment: "Text for field validation error shown when no text is entered for a required field.")
