...
struct GRPCCreateCredentialResponse {
  ...
  var credential: GRPCCredential {
    get {return _credential ?? GRPCCredential()}
  ...
  fileprivate var _credential: GRPCCredential? = nil
}
...
struct GRPCGetProfileResponse {
  ...
  var userProfile: GRPCUserProfile {
    get {return _userProfile ?? GRPCUserProfile()}
  ...
  fileprivate var _userProfile: GRPCUserProfile? = nil
}
...
extension GRPCCreateCredentialResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._credential)
      default: break
      }
    }
  }
...
extension GRPCDeleteUserRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeRepeatedStringField(value: &self.reasons)
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.reasons.isEmpty {
      try visitor.visitRepeatedStringField(value: self.reasons, fieldNumber: 1)
    }
